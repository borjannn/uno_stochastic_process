...
for i, num_players in enumerate(range(2, max_num_players + 1)):
    ...
    data_specials_high = df_specials_high[df_no_specials_high["num_players"] == num_players]["turns"]
    ...
    data_specials_medium = df_specials_medium[df_no_specials_medium["num_players"] == num_players]["turns"]
    ...
    data_specials_low = df_specials_low[df_no_specials_low["num_players"] == num_players]["turns"]
